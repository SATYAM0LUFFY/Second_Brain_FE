...
interface RightSignInProps{
  setSignIn : (signIn : boolean)=>void
} 



export function RightSignIn({ setSignIn} : RightSignInProps) {
  ...
  return (
    ...
    <div className="mx-20 my-8  max-w-[630px] flex flex-col gap-9">
        ...
        <button onClick={SignInOnClickHandler} className={`flex justify-center items-center gap-3  border-2 w-[350px] h-12 rounded-lg text-center text-white  mt-5 bg-[#C75051] self-center font-medium text-lg  hover:w-[400px] hover:h-14 transition-all duration-300 ease-out`}> 
